...
var UserRels = struct {
	UserIdPlayers        string
	UserIdUserStatistics string
}{
	UserIdPlayers:        "UserIdPlayers",
	UserIdUserStatistics: "UserIdUserStatistics",
}

// userR is where relationships are stored.
type userR struct {
	UserIdPlayers        PlayerSlice        `boil:"UserIdPlayers" json:"UserIdPlayers" toml:"UserIdPlayers" yaml:"UserIdPlayers"`
	UserIdUserStatistics UserStatisticSlice `boil:"UserIdUserStatistics" json:"UserIdUserStatistics" toml:"UserIdUserStatistics" yaml:"UserIdUserStatistics"`
}
...
func (r *userR) GetUserIdPlayers() PlayerSlice {
	if r == nil {
		return nil
	}
	return r.UserIdPlayers
}

func (r *userR) GetUserIdUserStatistics() UserStatisticSlice {
	if r == nil {
		return nil
	}
	return r.UserIdUserStatistics
}
...
// UserIdPlayers retrieves all the Player's Players with an executor via UserId column.
func (o *User) UserIdPlayers(mods ...qm.QueryMod) playerQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`Player`.`UserId`=?", o.ID),
	)

	return Players(queryMods...)
}

// UserIdUserStatistics retrieves all the UserStatistic's UserStatistics with an executor via UserId column.
func (o *User) UserIdUserStatistics(mods ...qm.QueryMod) userStatisticQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`UserStatistics`.`UserId`=?", o.ID),
	)

	return UserStatistics(queryMods...)
}

// LoadUserIdPlayers allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserIdPlayers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`Player`),
		qm.WhereIn(`Player.UserId in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.UserIdPlayers = resultSlice
...
// LoadUserIdUserStatistics allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserIdUserStatistics(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`UserStatistics.UserId in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.UserIdUserStatistics = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
...
// AddUserIdPlayers adds the given related objects to the existing relationships
// of the User, optionally inserting them as new records.
// Appends related to o.R.UserIdPlayers.
// Sets related.R.UserIdUser appropriately.
func (o *User) AddUserIdPlayers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Player) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			UserIdPlayers: related,
		}
	} else {
		o.R.UserIdPlayers = append(o.R.UserIdPlayers, related...)
	}
...
// Sets related.R.UserIdUser appropriately.
func (o *User) AddUserIdUserStatistics(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserStatistic) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserId = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			UserIdUserStatistics: related,
		}
	} else {
		o.R.UserIdUserStatistics = append(o.R.UserIdUserStatistics, related...)
	}
